...
const CarCard = ({ car }) => {
  ...
  return (
    ...
    transition-all duration-500 cursor-pointer'>
      ...
      <div className='realtive h-48 overflow-hidden'>
        <img src={car.image} alt="car image" className='w-full h-full object-cover
         transition-transform duration-500 group-hover:scale-105'/>

        {car.isAvailable && <p className='absolute top-4 left-4 bg-primary/90text-white 
      ...
      <div classname='p-4 sm:p-5'>
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="">
            <h3 calssName='text-lg font-medium'>{car.brand} {car.model}</h3>
