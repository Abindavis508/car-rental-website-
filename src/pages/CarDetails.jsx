    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
          ...
          <div>
            ...
            <div>
              ...
              <ul className='grid grid-cols-1 sm:grid-cols-3 gap-2'>
                {
                  ["360 camera", "Bluetooth", "Heated seats", "rear view mirror"]
                    .map((item) => (
      ...
      p-6 space-y-6 text-gray-500'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <input type="date" className='border border-borderColor px-3 y-2 rounded-lg' required id='pickup-date' min={new Date().toISOString().split('T')[0]} />
        </div>

        <div className='flex flex-col gap-2'>
          <label htmlFor="return-date">Return Date</label>
          <input type="date" className='border border-borderColor px-3 y-2 rounded-lg' required id='return-date' />
        </div>
