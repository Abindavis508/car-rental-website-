...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-0 flex-1'>
    ...
    max-w-3xl">
        ...
        {dashboardCards.map((card, index) => (
          <div className="flex gap-2 items-center justify-between p-4 rounded-md 
          border border-borderColor" key={index}>
            <div className="">
      ...
      <div className="flex flex-wrap items-start gap-6 w-full mb-8">
        ...
        w-full">
          ...
          {data.recentBookings.map((booking, index) => (
            <div className="mt-4 flex items-center justify-center" key={index}>
