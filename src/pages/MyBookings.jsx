  ...
  return (
    ...
    2xl:px-48 mt-16 text-sm max-w-7xl'>
      ...
      <Title title="My Bookings"
        subTitle="View and manage your all cars bookings"
        align="left" />
        ...
        p-6 border border-borderColor rounded-lg  mt-5 first:mt-12">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-start gap-2 mt-3">
               ...
               mt-1" />
                <div className="">
                  ...
                  <p className="">{booking.pickupDate.split('T')[0]} To {booking.returnDate.split
                    ('T')[0]}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 mt-3">
                ...
                <div className="">
                  <p className="text-gray-500 ">Picuk-up Location</p>
            ...
            <div className="md:col-sapn-1 flex flex-col justify-between gap-6">
